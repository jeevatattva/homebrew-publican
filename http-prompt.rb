class HttpPrompt < Formula
  ...
  desc "HTTPie + prompt_toolkit = an interactive command-line HTTP client"
  ...
  def install
    ...
    bin.install_symlink "http-prompt" => "httpcli"
  end

  test do
    assert_equal (system "http-prompt --version", "1.0.0")
  end
end
